...
| 5.4 guards | [`hooks/mesa-append-guard.sh`](hooks/mesa-append-guard.sh) enforces the append-only MESA |

The portable core (`bin/mesa.sh`, `bin/baton-cas.sh`, `templates/`, `tests/`) is
